...
第 6 条             匿名加工情報の取扱い
当社は、法令等に基づいた適正な加工方法に基づき、個人を識別することや個人情報を復元することができないようにした匿名加工情報を作成し、第三者に提供いたします。また、当社は、今後も継続的に同様の匿名加工情報を作成し、第三者に提供することを予定しております。当社において作成及び提供する匿名加工情報に含まれる情報の項目及び提供の方法は次に掲げるとおりです。
...
第 7 条             本個人情報の管理
当社は、取得した本個人情報を厳重に保管及び管理し、外部への漏洩防止や不正行為による流出、破壊又は改ざんなどに関して適切なセキュリティ対策の実施を含む安全管理措置を講じ、本個人情報を保護します。なお、当社が講じる具体的な安全管理措置の内容については、第12条に定める窓口までお問合せください。
